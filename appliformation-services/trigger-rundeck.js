...
const USAGE = "Usage: node trigger-rundeck.js RUNDECK_HOST RUNDECK_JOB_ID RUNDECK_TOKEN RUNDECK_SERVICE_VERSION";
...
function trigger(resolve, reject) {
    ...
    const body = {
        "argString": "-PROJECT_VERSION " + version + " -SERVICE_VERSION " + version
    };
