...
const logger: Logger = Logger.getLogger("appliformation-js-lite.mock.services.data.auth.auth-service-mock-impl");
...
const users = [
    {
        "name": "test",
        "roles": [{"id": 2, "name": "appliformation-js-lite_USER"}]
    },
    {
        "name": "admin",
        "roles": [{"id": 1, "name": "appliformation-js-lite_ADMIN"}, {"id": 2, "name": "appliformation-js-lite_USER"}]
    }
];
